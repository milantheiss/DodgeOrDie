...
public class Menus {
    ...
    public Menus(){
        ...
        MAIN_MENU_CONTAINER.getComponents().get(1).setMarginTop(MAIN_MENU_CONTAINER.getComponents().get(1).getHeight()/2);
        MAIN_MENU_CONTAINER.getComponents().get(2).setMarginTop(MAIN_MENU_CONTAINER.getComponents().get(1).getHeight()/2);
        ...
        PAUSE_MENU_CONTAINER.getComponents().get(1).setMarginTop(MAIN_MENU_CONTAINER.getComponents().get(1).getHeight()/2);
        PAUSE_MENU_CONTAINER.getComponents().get(2).setMarginTop(MAIN_MENU_CONTAINER.getComponents().get(1).getHeight()/2);
        ...
        ENDLESS_MENU_CONTAINER.getComponents().get(1).setMarginTop(MAIN_MENU_CONTAINER.getComponents().get(1).getHeight()/2);
        ENDLESS_MENU_CONTAINER.getComponents().get(2).setMarginTop(MAIN_MENU_CONTAINER.getComponents().get(1).getHeight()/2);
