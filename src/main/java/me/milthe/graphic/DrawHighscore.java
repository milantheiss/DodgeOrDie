...
public class DrawHighscore {
    ...
    public void render(GraphicsContext g) {
        ...
        g.fillText("Zeit  überlebt:  " + Highscore.getSurvivedtime(), (Gui.WIDTH - 470) / 2, (Gui.HEIGHT - 182) / 2);
        g.fillText("Gegner  überlebt: " + Highscore.getSurvivedenemies(), (Gui.WIDTH - 560) / 2, (Gui.HEIGHT - 43) / 2);
        g.fillText("Höchste Anzahl an Leben:   " + Highscore.getHighestnumberhealth(), (Gui.WIDTH - 730) / 2, (Gui.HEIGHT + 96) / 2);
