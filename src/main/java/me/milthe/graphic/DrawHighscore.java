...
public class DrawHighscore {
    ...
    public void render(GraphicsContext g) {
        ...
        g.fillText("Zeit  überlebt:  " + Highscore.getSurviedtime(), (Gui.width - 590) / 2, (Gui.height - 43) / 2);
        g.fillText("Gegner  überlebt: " + Highscore.getSurviedenemies(), (Gui.width - 560) / 2, (Gui.height - 182) / 2);
